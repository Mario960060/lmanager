...
const WallFinishCalculator: React.FC<TileInstallationCalculatorProps> = ({ 
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Tile Installation Calculator</h2>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Slab Dimensions</label>
        <select
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Slab Orientation</label>
        <div className="mt-2 grid grid-cols-1 gap-2">
          <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
            ...
            />
            <span className="ml-2">Slabs Long Way</span>
          </label>
          <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
            <input
              type="radio"
              ...
              className="text-blue-600 focus:ring-blue-500"
            />
            <span className="ml-2">Slabs Side Ways</span>
          </label>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Slab Cutting (Length)</label>
          <div className="grid grid-cols-1 gap-2">
            <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
              <input
                ...
                className="text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2">1 cut (at the end)</span>
            </label>
            <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
              <input
                type="radio"
                ...
                className="text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2">2 cuts (same on beginning and end)</span>
            </label>
          </div>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Slab Cutting (Height)</label>
          <div className="grid grid-cols-1 gap-2">
            <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
              <input
                type="radio"
                ...
                className="text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2">1 cut (on the top)</span>
            </label>
            <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
              <input
                type="radio"
                ...
                className="text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2">2 cuts (same on bottom and top)</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Type of Slabs</label>
        <div className="mt-2 grid grid-cols-1 gap-2">
          <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
            <input
              type="radio"
              ...
              className="text-blue-600 focus:ring-blue-500"
            />
            <span className="ml-2">Porcelain</span>
          </label>
          <label className="inline-flex items-center p-2 rounded-md hover:bg-gray-50">
            <input
              type="radio"
              ...
              className="text-blue-600 focus:ring-blue-500"
            />
            <span className="ml-2">Sandstones</span>
          </label>
        </div>
      </div>
      ...
      {results && (
        <div className="mt-6 space-y-4" ref={resultsRef}>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Slab Cutting Breakdown</h3>
