            ...
            <div className="absolute z-10 mt-1 w-full rounded-md bg-white shadow-lg border border-gray-200">
              ...
              <ul className="max-h-60 overflow-auto">
                {filteredTasks.length === 0 ? (
                  <li className="px-3 py-2 text-gray-500">No tasks found.</li>
                ) : (
          ...
          {result && (
            <div className="mt-4 p-4 bg-gray-800 rounded-md space-y-3">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-gray-300">Total Hours Needed</div>
                  <div className="text-2xl font-bold text-white">
                    {result.totalHours}h
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-300">Hours per Worker</div>
                  <div className="text-2xl font-bold text-white">
                    {result.perWorker}h
                  </div>
                </div>
              ...
              <div className="pt-3 border-t border-gray-700">
                <div className="text-sm text-gray-300">Estimated Working Days</div>
                <div className="text-2xl font-bold text-white">
                  {result.days} days
                </div>
