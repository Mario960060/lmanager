    ...
    <div className="space-y-4">
      ...
      {result && (
        <div ref={resultsRef} className="mt-6 space-y-4 bg-gray-800 p-4 rounded-md">
          <div>
            <h3 className="text-lg font-medium text-white">Total Volume: <span className="text-blue-400">{result.volume} m³</span></h3>
            <p className="text-sm text-gray-300 mt-1">(Approximately {(result.volume * 1.5).toFixed(2)} tonnes)</p>
          </div>
          
          <div>
            <h3 className="font-medium mb-2 text-white">Materials Required:</h3>
