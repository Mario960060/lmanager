...
const SleeperWallCalculator: React.FC<SleeperWallCalculatorProps> = ({ 
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-semibold">Sleeper Wall Calculator</h2>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            step="0.01"
            placeholder="Enter wall length in metres"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 form-input"
            step="0.01"
            placeholder="Enter wall height in metres"
          />
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700">Post Installation Method</label>
          <div className="mt-2 space-x-4">
            <label className={`inline-flex items-center p-2 rounded text-white ${postMethod === 'concrete' ? 'bg-blue-600' : 'bg-gray-500'}`}>
              ...
              />
              <span className="ml-2">Concrete in Posts</span>
            </label>
            <label className={`inline-flex items-center p-2 rounded text-white ${postMethod === 'direct' ? 'bg-blue-600' : 'bg-gray-500'}`}>
              <input
                ...
                className="form-radio"
              />
              <span className="ml-2">Drive Posts Directly</span>
            </label>
          </div>
        </div>
          ...
          <div ref={resultsRef} className="mt-6 space-y-4">
            ...
            {postMethod === 'concrete' && result.postHeightMeters && (
              <div className="p-4 bg-gray-50 border border-gray-200 rounded-md">
                <p className="font-medium mb-2 text-white">Post Calculation Details:</p>
            ...
            <div>
              <h3 className="text-lg font-medium">Total Labor Hours: <span className="text-blue-600">{result.labor.toFixed(2)} hours</span></h3>
            ...
            <div>
              <h4 className="font-medium text-gray-700 mb-2">Materials Required:</h4>
