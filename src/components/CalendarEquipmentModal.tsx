    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-2xl w-full">
        <div className="flex justify-between items-center p-6 border-b">
          <div>
            <h2 className="text-xl font-semibold">Require Equipment</h2>
            ...
            {equipment.map(item => (
              ...
              >
                ...
                <div className="text-sm text-gray-600 mt-1">
                  <p>Type: {item.type}</p>
                  <p>Available: {item.quantity - item.in_use_quantity} of {item.quantity}</p>
                </div>
              </div>
            ))}
            {equipment.length === 0 && (
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-600 focus:ring-gray-600"
                  placeholder="Add any notes about this equipment requirement..."
                />
              </div>
            </>
          )}
        ...
        <div className="p-6 border-t bg-gray-50">
          ...
          >
            {requireEquipmentMutation.isPending ? 'Requiring...' : 'Require Equipment'}
          </button>
        </div>
      </div>
    </div>
