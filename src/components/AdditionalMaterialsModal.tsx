    ...
    <>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
          ...
          <div className="p-4 border-b dark:border-gray-700">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search materials by name or project..."
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {isLoading ? (
                    ...
                    <div className="flex justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mb-1">
                          Project: <span className="font-medium">{material.events?.title || 'Unknown Project'}</span>
                        </p>
                        <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                          Added on {new Date(material.created_at).toLocaleDateString()} at {new Date(material.created_at).toLocaleTimeString()}
                        </p>
                      </div>
                      <button
              ...
              <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                {searchTerm ? "No materials match your search." : "You haven't added any additional materials yet."}
              </div>
            )}
          </div>
        </div>
      ...
      {deleteConfirmation.isOpen && (
        <DeleteConfirmation
          ...
          recordType="Additional Material"
