                          ...
                          >
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <p className="text-sm text-gray-600">
                                  Progress: {item.totalAmount} {item.unit}
                                </p>
                              </div>
                              <p className="text-sm font-medium text-blue-600">
                                {item.totalHours} hours spent
                              </p>
                            </div>
                          </div>
                        ))
                      ...
                      {selectedDataType === 'hours' && (
                        <div className="space-y-4">
                          <div className="bg-blue-50 p-4 rounded-lg">
                            <h3 className="font-medium text-blue-900">Total Project Hours</h3>
                            <p className="text-2xl font-bold text-blue-600 mt-1">
                              {performanceData.total} hours
                            </p>
                          </div>
                        ...
                        performanceData.map((item: any) => (
                          ...
                          >
                            <div className="flex justify-between items-start">
                              ...
                              <p className="text-sm font-medium text-blue-600">
                                {item.hours_needed} hours needed
                              </p>
                            </div>
                            <div className="mt-2 text-sm text-gray-600">
                              <p>Period: {format(parseISO(item.start_date), 'MMM d')} - {format(parseISO(item.end_date), 'MMM d, yyyy')}</p>
                              {item.materials_needed && (
                                <p className="mt-1">Materials: {item.materials_needed}</p>
                              )}
                            </div>
                          </div>
                        ))
