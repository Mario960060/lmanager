      ...
      <div className="bg-white rounded-lg max-w-2xl w-full">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="max-h-60 overflow-y-auto border rounded-lg">
            ...
            >
              <h3 className="font-medium text-blue-600">+ Other (Custom Item)</h3>
              <p className="text-sm text-gray-600 mt-1">Add a custom item with additional details</p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-1">Add a custom material not in the list</p>
            </div>
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={selectedMaterial.id === 'custom' ? 'Enter material name' : ''}
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={selectedMaterial.id === 'custom' ? 'Enter unit (e.g. kg, pcs)' : ''}
                />
              </div>
