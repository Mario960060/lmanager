                  ...
                  <div key={task.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Project: {task.events?.title}
                        </p>
                      </div>
                      <button
                        onClick={() => handleDeleteClick(task.id, task.description || 'Unnamed Task')}
                    ...
                    <div className="mt-3 space-y-2">
                      ...
                      <div className="flex justify-between items-center text-sm">
                        <span>Hours: {task.hours_spent} / {task.hours_needed}</span>
                        <span className="text-gray-600">
                          {((task.hours_spent / task.hours_needed) * 100).toFixed(1)}% of estimated time
                        </span>
                      </div>
                    </div>
                    ...
                    {task.latest_progress && (
                      <div className="mt-3 text-sm text-gray-600 dark:text-gray-400">
                        <p>Last updated: {new Date(task.latest_progress.created_at).toLocaleDateString()}</p>
                        {task.latest_progress.notes && (
                          <p className="mt-1">Notes: {task.latest_progress.notes}</p>
                        )}
                      </div>
                    )}
