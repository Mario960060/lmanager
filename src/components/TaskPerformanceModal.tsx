    ...
    <>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {isLoadingProgress ? (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Project: {task.eventTitle}
                        </p>
                        <div className="mt-1 grid grid-cols-2 gap-4">
                          <div>
                            <span className="text-sm text-gray-500 dark:text-gray-400">Average Time:</span>
                          ...
                          <table className="w-full">
                            <thead>
                              <tr className="border-b dark:border-gray-700">
                                ...
                                <th className="text-right py-2 px-4">Total Completed</th>
                                <th className="text-right py-2 px-4">Hours Spent</th>
                                <th className="text-right py-2 px-4">Amount per Hour</th>
              ...
              <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                {searchTerm ? "No tasks match your search." : "No task progress data available yet."}
              </div>
            )}
          </div>
        </div>
      ...
      {deleteConfirmation.isOpen && (
        <DeleteConfirmation
          ...
          recordType="Task Performance Entry"
