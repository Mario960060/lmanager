      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center sticky top-0 bg-white dark:bg-gray-800 z-10">
          <h2 className="text-xl font-semibold flex items-center">
            ...
            Delete Additional Materials Records
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 border-b dark:border-gray-700">
          <input
            type="text"
            placeholder="Search additional materials records..."
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-red-500 dark:text-red-400 text-center">
                Error loading additional materials records.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-center">
                {searchTerm ? "No records match your search." : "No additional materials records found."}
              </p>
            </div>
          ) : (
                          ...
                          <div className="flex justify-between">
                            <div>
                              <h3 className="font-medium text-blue-600 dark:text-blue-400">
                                {record.material || 'Unnamed Material'}
                              </h3>
                              <div className="mt-1 text-sm">
                                ...
                                <div className="mt-1">
                                  <span className="font-medium">Quantity:</span> {record.quantity} {record.unit || ''}
                                </div>
                                {record.event_title && (
                                  <div className="mt-1">
