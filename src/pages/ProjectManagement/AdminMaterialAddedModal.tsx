  ...
  const { data: userGroups = [], isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      ...
      const processedRecords = records.map(record => {
        return {
          ...record,
          material_name: record.materials?.name || 'Unnamed Material'
        };
      });
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 border-b dark:border-gray-700">
          <input
            type="text"
            placeholder="Search material added records..."
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-red-500 dark:text-red-400 text-center">
                Error loading material added records.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-center">
                {searchTerm ? "No records match your search." : "No material added records found."}
              </p>
            </div>
          ) : (
                          ...
                          <div className="flex justify-between">
                            <div>
                              <h3 className="font-medium text-blue-600 dark:text-blue-400">
                                {record.material_name || 'Unnamed Material'}
                              </h3>
