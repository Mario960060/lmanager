                          ...
                          <div className="flex justify-between">
                            <div className="flex-1">
                              <h3 className="font-medium text-blue-600 dark:text-blue-400">
                                {record.description || 'Unnamed Task'}
                              </h3>
                              <div className="mt-1 text-sm">
                                ...
                                {record.events?.title && (
                                  <div className="mt-1">
                                    <span className="font-medium">Project:</span> {record.events.title}
                                  </div>
                                )}
                                {record.description && (
                                  <div className="mt-1">
                                ...
                                <div className="mt-3 space-y-2">
                                  ...
                                  <div className="flex justify-between items-center">
                                    <span>Hours: {record.hours_spent || 0} / {record.hours_needed || 0}</span>
                                    <span className="text-gray-500">
                                      {record.hours_needed ? ((record.hours_spent / record.hours_needed) * 100).toFixed(1) : 0}% of estimated time
                                    </span>
                                  </div>
                                </div>
                                    ...
                                    {record.additional_task_progress_entries
                                      ...
                                      .map((entry, index) => (
                                        <div key={index} className="text-sm">
                                          <div>Progress: {entry.progress_percentage}%</div>
                                          <div>Hours Added: {entry.hours_spent}</div>
                                          <div>Date: {formatDate(entry.created_at)}</div>
