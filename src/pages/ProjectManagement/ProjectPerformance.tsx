  ...
  const { data: deliveredMaterials = [], isLoading: isMaterialsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      data.forEach((delivery: any) => {
        ...
        const name = delivery.materials?.name || 'Unknown Material';
            ...
            <>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="bg-gray-700 text-white rounded-lg mb-4">
                  ...
                  >
                    <div>
                      <h3 className="font-medium">Total Project Hours</h3>
                      <p className="text-3xl font-bold mt-1">{performanceData.totalHours.toFixed(2)} hours</p>
                    </div>
                      ...
                      <div key={userId} className="bg-gray-700 text-white rounded-lg">
                        ...
                        <div>
                          <h3 className="font-medium">{userData.userName}</h3>
                            <p className="text-lg font-semibold mt-1">{userData.totalHours.toFixed(2)} hours</p>
                        </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg mt-6">
                ...
                >
                  <h2 className="text-xl font-semibold">Materials Delivered</h2>
                ...
                {materialsOpen && (
                  <div className="mt-6">
                    {isMaterialsLoading ? (
                      ...
                      <div className="text-center text-gray-500">No materials delivered in this period.</div>
                    ) : (
