    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-lg font-semibold dark:text-white">Machinery Task Creator</h2>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto flex-grow dark:bg-gray-800">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center h-64">
              ...
              <p className="text-gray-500 dark:text-gray-400">Loading equipment data...</p>
            </div>
          ) : error ? (
            ...
            <>
              <div className="mb-6">
                ...
                <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  <li>Load-in and compacting sand task</li>
                </ul>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-md text-yellow-800 dark:text-yellow-300 text-sm border border-yellow-200 dark:border-yellow-800">
                  ...
                  <p>
                    ...
                    This will create {newExcavators.length * newCarriers.length * 3} new tasks in total.
                  </p>
                </div>
              </div>
