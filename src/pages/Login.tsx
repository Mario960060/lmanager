  ...
  return (
    ...
    >
      ...
      <div style={{ width: '100%', maxWidth: 420, textAlign: 'center' }}>
        ...
        {/* Footer: contact + tutorial in one row; Instagram centered below */}
        <div style={{ fontSize: fontSizes.sm, color: colors.textSubtle }}>
          <div
            style={{
              display: 'flex',
              flexWrap: 'wrap',
          ...
          <div style={{ marginTop: spacing['5xl'], display: 'flex', justifyContent: 'center' }}>
            <a
