          ...
          >
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center text-sm text-blue-600">
                ...
                <span>Tools: {task.tools.length}</span>
              </div>
              <div className="flex items-center text-sm text-green-600">
                <Package className="w-4 h-4 mr-2" />
                <span>Materials: {task.materials.length}</span>
              </div>
            </div>
          </div>
        ))}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-blue-900 mb-2">Required Tools</h3>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="text-sm font-medium text-green-900 mb-2">Required Materials</h3>
                  <ul className="space-y-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] flex flex-col">
            <div className="p-6 border-b">
              <div className="flex justify-between items-start">
                <h2 className="text-2xl font-semibold text-gray-900">Add New Task Requirements</h2>
                <button
            ...
            <div className="p-6 border-t bg-gray-50">
              ...
              >
                {addTaskMutation.isPending ? 'Adding...' : 'Add Task Requirements'}
              </button>
            </div>
          </div>
        </div>
      ...
      {showEditModal && editingTask && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] flex flex-col">
            <div className="p-6 border-b">
              <div className="flex justify-between items-start">
                <h2 className="text-2xl font-semibold text-gray-900">Edit Task Requirements</h2>
                <button
                  onClick={() => {
                    setShowEditModal(false);
                    setEditingTask(null);
