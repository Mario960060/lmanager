    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Welcome to Landscaper Manager</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">
            You don't have access to a team yet. Choose how you'd like to proceed.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 mb-8 border-l-4 border-blue-600 dark:border-blue-500">
          <p className="text-gray-700 dark:text-gray-300">
            <span className="font-semibold text-blue-600 dark:text-blue-400">💳 This application is premium.</span> To create your own team or join an existing one, you'll need to be part of an active subscription.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-3">Create Your Team</h2>
            <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
              Start your own company account and begin managing your landscape projects immediately.
            </p>
            <div className="bg-blue-50 dark:bg-slate-700 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-300 mt-2 space-y-1">
                <li>✓ Full control over your team</li>
                <li>✓ Invite team members</li>
                <li>✓ Manage all projects and tasks</li>
                <li>✓ Set up your equipment and materials</li>
              </ul>
            </div>
            <button
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-3">Wait for Invitation</h2>
            <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
              If an existing team admin has invited you, they'll need to send you an invitation link.
            </p>
            <div className="bg-green-50 dark:bg-slate-700 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-green-800 dark:text-green-300 mt-2 space-y-1">
                <li>✓ Ask a team admin to invite you</li>
                <li>✓ They'll send you an invitation email</li>
                <li>✓ Click the link to accept</li>
                <li>✓ You'll gain access to their team</li>
              </ul>
            </div>
            <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4">
              <p className="text-sm text-amber-800 dark:text-amber-300">
                <strong>ℹ️ Tip:</strong> Contact your team admin and ask them to add you to their team. You'll need their team name or direct invitation.
              </p>
            </div>
          </div>
        </div>
