...
function theme(config: {
  ...
  /** Button variants (danger / success) — dark theme can set gold like gradPrimary */
  gradDanger: string; gradSuccess: string;
  shadowDangerBtnIdle: string; shadowDangerBtnHover: string;
  shadowSuccessBtnIdle: string; shadowSuccessBtnHover: string;
  // Diagram
  ...
  return {
    ...
    "--grad-danger": config.gradDanger,
    "--grad-success": config.gradSuccess,
    "--shadow-danger-btn-idle": config.shadowDangerBtnIdle,
    "--shadow-danger-btn-hover": config.shadowDangerBtnHover,
    "--shadow-success-btn-idle": config.shadowSuccessBtnIdle,
    "--shadow-success-btn-hover": config.shadowSuccessBtnHover,
...
// ═════════════════════════════════════════════════════════════════
// 🌙 DARK — gold accent (primary buttons, ghost, accentAlpha glows via --accent-rgb)
// ═════════════════════════════════════════════════════════════════
export const darkTheme: ThemeConfig = {
  ...
  vars: theme({
    ...
    bgCardInner: "#1a2332", bgInput: "#1a2332", bgElevated: "#1e293b",
    ...
    bgTableRowAlt: "rgba(255,255,255,0.06)",
    bgDeep: "#1a2536", bgDeepBorder: "#1e2d44", bgDeepBorderLight: "#253350",
    bgInputDark: "#1e2d44", bgInputDarkAlpha: "rgba(30,45,68,0.6)", bgSegmentInput: "#1a2332",
    ...
    borderInput: "rgba(212,175,55,0.35)", borderInputFocus: "rgba(212,175,55,0.55)",
    borderHover: "rgba(255,255,255,0.10)", borderInputDark: "#253350", borderSegment: "#2a2a4a",
    textPrimary: "#f1f5f9", textSecondary: "#e2e8f0", textMuted: "#e0e6ed",
    textSubtle: "#c8d2e0", textDim: "#b8c4d4", textFaint: "#a8b8cc", textGhost: "#8a9ab0",
    textWarm: "#7a8ba5", textCool: "#8a9ab5", textLabel: "#556680",
    textPrimaryLight: "#e4e9f0", textOnAccent: "#0f172a", textDisabled: "#3a4a60",
    textSegment: "#e0e0e0", textSegmentLabel: "#888888",
    navIconInactive: "#4b5563", navTextInactive: "#9ca3af",
    accent: "#e8c547", accentDark: "#d4af37", accentDeep: "#b8860b",
    accentBg: "rgba(212,175,55,0.15)", accentBorder: "rgba(212,175,55,0.28)",
    accentGlow: "rgba(212,175,55,0.38)",
    accentR: "212", accentG: "175", accentB: "55",
    ...
    statusDoneBg: "rgba(212,175,55,0.10)", statusDoneBorder: "rgba(212,175,55,0.22)",
    statusDoneText: "#f0d78c", statusDoneDot: "#e8c547",
    ...
    shadowAccent: "0 4px 20px rgba(212,175,55,0.35)",
    shadowAccentHover: "0 6px 28px rgba(212,175,55,0.52)",
    shadowCardHover: "0 4px 20px rgba(0,0,0,0.2)",
    shadowModal: "0 16px 48px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.06)",
    // Primary CTAs: bright mustard → rich gold (avoid #b8860b end; dark text stays readable)
    gradPrimary: "linear-gradient(135deg, #f4d052, #d4af37)",
    gradLogo: "linear-gradient(135deg, #f0d060, #c9a227)",
    gradAvatar: "linear-gradient(135deg, #e8c547, #d4af37)",
    gradSubtle: "linear-gradient(135deg, rgba(212,175,55,0.12), rgba(212,175,55,0.04))",
    gradCard: "linear-gradient(135deg, rgba(212,175,55,0.10), rgba(212,175,55,0.02))",
    gradSave: "linear-gradient(135deg, #f4d052, #d4af37)",
    gradTeam: "linear-gradient(135deg, #3d3518, #1a1408)",
    gradDanger: "linear-gradient(135deg, #f4d052, #d4af37)",
    gradSuccess: "linear-gradient(135deg, #f4d052, #d4af37)",
    shadowDangerBtnIdle: "0 4px 12px rgba(212,175,55,0.35)",
    shadowDangerBtnHover: "0 6px 20px rgba(212,175,55,0.5)",
    shadowSuccessBtnIdle: "0 4px 12px rgba(212,175,55,0.35)",
    shadowSuccessBtnHover: "0 6px 20px rgba(212,175,55,0.5)",
...
export const lightTheme: ThemeConfig = {
  ...
  vars: theme({
    ...
    gradDanger: "linear-gradient(135deg, #dc2626, #ef4444)",
    gradSuccess: "linear-gradient(135deg, #16a34a, #22c55e)",
    shadowDangerBtnIdle: "0 4px 12px rgba(220,38,38,0.35)",
    shadowDangerBtnHover: "0 6px 20px rgba(220,38,38,0.45)",
    shadowSuccessBtnIdle: "0 4px 12px rgba(22,163,74,0.35)",
    shadowSuccessBtnHover: "0 6px 20px rgba(22,163,74,0.45)",
...
export const oceanTheme: ThemeConfig = {
  ...
  vars: theme({
    ...
    bgCardInner: "#143050", bgInput: "#143050", bgElevated: "#183a5e",
    bgHover: "rgba(255,255,255,0.04)", bgSubtle: "rgba(255,255,255,0.02)",
    bgOverlay: "rgba(255,255,255,0.03)", bgModalBackdrop: "rgba(0,0,0,0.6)",
    bgTableRowAlt: "rgba(255,255,255,0.06)",
    bgDeep: "#0d1f35", bgDeepBorder: "#1a3a5c", bgDeepBorderLight: "#204870",
    bgInputDark: "#1a3a5c", bgInputDarkAlpha: "rgba(26,58,92,0.6)", bgSegmentInput: "#143050",
    borderDefault: "rgba(255,255,255,0.06)", borderLight: "rgba(255,255,255,0.04)",
    borderMedium: "rgba(255,255,255,0.08)", borderSubtle: "rgba(255,255,255,0.05)",
    ...
    textPrimary: "#ecfeff", textSecondary: "#cffafe", textMuted: "#b8f5fc",
    textSubtle: "#8ef0f9", textDim: "#5ee0f0", textFaint: "#2dd4e9", textGhost: "#0891b2",
    textWarm: "#7dd3fc", textCool: "#38bdf8", textLabel: "#5ee0f0",
    textPrimaryLight: "#cffafe", textOnAccent: "#ffffff", textDisabled: "#164e63",
    textSegment: "#cffafe", textSegmentLabel: "#5ee0f0",
    navIconInactive: "#2dd4e9", navTextInactive: "#5ee0f0",
    ...
    gradDanger: "linear-gradient(135deg, #ef4444, #f87171)",
    gradSuccess: "linear-gradient(135deg, #22c55e, #4ade80)",
    shadowDangerBtnIdle: "0 4px 12px rgba(239,68,68,0.35)",
    shadowDangerBtnHover: "0 6px 20px rgba(239,68,68,0.45)",
    shadowSuccessBtnIdle: "0 4px 12px rgba(34,197,94,0.35)",
    shadowSuccessBtnHover: "0 6px 20px rgba(34,197,94,0.45)",
...
export const forestTheme: ThemeConfig = {
  ...
  vars: theme({
    ...
    bgCardInner: "#223526", bgInput: "#223526", bgElevated: "#2a3e2e",
    bgHover: "rgba(255,255,255,0.04)", bgSubtle: "rgba(255,255,255,0.02)",
    bgOverlay: "rgba(255,255,255,0.03)", bgModalBackdrop: "rgba(0,0,0,0.6)",
    bgTableRowAlt: "rgba(255,255,255,0.06)",
    bgDeep: "#1a2a1c", bgDeepBorder: "#2a3e2e", bgDeepBorderLight: "#345038",
    bgInputDark: "#2a3e2e", bgInputDarkAlpha: "rgba(42,62,46,0.6)", bgSegmentInput: "#223526",
    borderDefault: "rgba(255,255,255,0.06)", borderLight: "rgba(255,255,255,0.04)",
    borderMedium: "rgba(255,255,255,0.08)", borderSubtle: "rgba(255,255,255,0.05)",
    ...
    textPrimary: "#f0fdf4", textSecondary: "#dcfce7", textMuted: "#c8f9d4",
    textSubtle: "#9cf6b8", textDim: "#6ee99a", textFaint: "#4ade80", textGhost: "#22c55e",
    textWarm: "#a3e635", textCool: "#9cf6b8", textLabel: "#6ee99a",
    textPrimaryLight: "#dcfce7", textOnAccent: "#ffffff", textDisabled: "#14532d",
    textSegment: "#dcfce7", textSegmentLabel: "#6ee99a",
    navIconInactive: "#4ade80", navTextInactive: "#6ee99a",
